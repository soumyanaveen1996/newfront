;(function() {
        ...
        return authContext
            ...
            .then(function(user) {
                if (message.getMessageType() === 'button_response') {
                    ...
                    Contact.getContactFieldForUUIDs(contact.userId).then(
                        function(contacts) {
                            if (_.isEmpty(contacts)) {
                                ...
                                if (ADD_CONTACT_ACTION === action) {
                                    agentGuardService
                                        ...
                                        .then(function() {
                                            var Message = botContext.getCapability(
                                                'Message'
                                            )
                                ...
                                var contactStatus = contacts[0].ignored
                                    ? 'ignored'
                                    : 'added'
                                tell(
                                    'Contact ' +
            ...
            .catch(function(err) {
                tell(
                    'Error occurred making the call to agent guard' + err,
                    botContext
                )
            })
    }
    ...
    var asyncResult = function asyncResult(
        ...
        authContext
            ...
            .then(function(user) {
                ...
                return conversationContext.getConversationContext(
                    botContext,
                    user
                )
            })
    ...
    var getUserInfo = function getUserInfo(
        ...
        var params = {
            ...
            fields: ['emailAddress', 'userName', 'userId']
        }
