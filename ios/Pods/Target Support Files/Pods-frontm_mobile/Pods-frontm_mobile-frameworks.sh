...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/JitsiMeetFrontmSDK/JitsiMeetSDK.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/react-native-webrtc/WebRTC.framework"
fi
