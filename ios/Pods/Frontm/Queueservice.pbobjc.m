...
@implementation BufferMessage

@dynamic message;

typedef struct BufferMessage__storage_ {
  uint32_t _has_storage_[1];
  NSData *message;
} BufferMessage__storage_;
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "message",
        .dataTypeSpecific.className = NULL,
        .number = BufferMessage_FieldNumber_Message,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(BufferMessage__storage_, message),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeBytes,
      },
    };
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[BufferMessage class]
                                     rootClass:[QueueserviceRoot class]
                                          file:QueueserviceRoot_FileDescriptor()
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
                                   storageSize:sizeof(BufferMessage__storage_)
                                         flags:GPBDescriptorInitializationFlag_None];
    NSAssert(descriptor == nil, @"Startup recursed!");
    descriptor = localDescriptor;
  }
