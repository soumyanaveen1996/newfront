    ...
    new Promise((resolve, reject) => {
        db.transaction(transaction => {
            transaction.executeSql(
                backgroundTaskSql.createBackgroundTaskTable,
                null,
                function success() {
                    return resolve();
                },
...
const updateBackgroundTaskLastRun = (key, botId, conversationId, lastRunTime) =>
    new Promise((resolve, reject) => {
        const args = [lastRunTime, key, botId, conversationId];

        db.transaction(transaction => {
            transaction.executeSql(
                backgroundTaskSql.updateLastRunTime,
                args,
...
const insertBackgroundTask = (
    ...
    new Promise((resolve, reject) => {
        ...
        db.transaction(transaction => {
            transaction.executeSql(
                backgroundTaskSql.insertBackgroundTask,
                args,
                function success(tx, res) {
                    return resolve();
                },
...
const deleteBackgroundTask = (key, botId, conversationId) =>
    new Promise((resolve, reject) => {
        const args = [key, botId, conversationId];
        db.transaction(transaction => {
            transaction.executeSql(
                backgroundTaskSql.deleteBackgroundTask,
                args,
                function success() {
                    return resolve(true);
                },
...
const selectAllBackgroundTasks = () =>
    new Promise((resolve, reject) => {
        db.transaction(transaction => {
            transaction.executeSql(
                backgroundTaskSql.selectAllBackgroundTasks,
                [],
                function success(tx, res) {
...
const selectBackgroundTask = (key, botId, conversationId) =>
    new Promise((resolve, reject) => {
        const args = [key, botId, conversationId];
        db.transaction(transaction => {
            transaction.executeSql(
                backgroundTaskSql.selectBackgroundTask,
                args,
                function success(tx, res) {
                    res = Utils.addArrayToSqlResults(res);
                    let dbResults = res.rows
...
const insertBackgroundTaskIfNotPresent = (
    key,
    botId,
    conversationId,
    timeInterval,
...
const deleteAllTasks = () =>
    new Promise((resolve, reject) => {
        db.transaction(transaction => {
            transaction.executeSql(
                backgroundTaskSql.deleteAllTasks,
                [],
                function success() {
                    resolve();
                },
