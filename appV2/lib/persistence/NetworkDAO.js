...
const createNetworkRequestQueueTable = () =>
    new Promise((resolve, reject) => {
        db.transaction((tx) => {
            tx.executeSql(
                networkSql.createNetworkQueueTable,
                null,
                function success() {
                    return resolve();
                },
...
const insertNetworkRequest = (
    key,
    requestOptions,
    status = networkSql.STATUS_CONSTANTS.pending,
    result = '',
    messageId = '',
    createdAt = undefined,
    updatedAt = undefined
    ...
    new Promise((resolve, reject) => {
        ...
        db.transaction((tx) => {
            tx.executeSql(
                networkSql.insertNetworkOperation,
                args,
...
const updateNetworkRequestStatus = (id, status, result) =>
    new Promise((resolve, reject) => {
        let resultFormatted = '';
        try {
            resultFormatted = JSON.stringify(result);
...
const deleteNetworkRequest = (id) =>
    new Promise((resolve, reject) => {
        ...
        db.transaction((tx) => {
            tx.executeSql(
                networkSql.deleteNetworkOperation,
                args,
                function success() {
                    return resolve();
                },
...
const selectFirstPendingNetworkRequest = () =>
    new Promise((resolve, reject) => {
        const args = [];
        db.transaction((tx) => {
            tx.executeSql(
                networkSql.selectPendingEarliestNetworkRequest,
                args,
                function success(tx2, res) {
...
const selectCompletedNetworkRequests = (key) =>
    new Promise((resolve, reject) => {
        ...
        db.transaction((tx) => {
            tx.executeSql(
                networkSql.selectCompletedtNetworkRequestForKey,
                args,
                function success(tx2, res) {
                    res = Utils.addArrayToSqlResults(res);
                    let dbResults = res.rows
    ...
    new Promise((resolve, reject) => {
        db.transaction((transaction) => {
            transaction.executeSql(
                networkSql.createV2NetworkQueueTable,
                null,
                function success() {
                    return resolve();
                },
...
const renameToTemp = () =>
    new Promise((resolve, reject) => {
        db.transaction((transaction) => {
            transaction.executeSql(
                'ALTER TABLE network_queue RENAME TO tmp_network_queue;',
                null,
                function success() {
                    return resolve();
                },
                    ...
                    let operations = dbOperations.map((dbOperation) => {
                        return {
                            ...
                            created_at_date: moment(
                                dbOperation.created_at_date
                            ).toDate(),
                            updated_at_date: moment(
                                dbOperation.updated_at_date
                            ).toDate(),
...
const migrateToV3NetworkQueue = () =>
    new Promise((resolve, reject) => {
        db.transaction((tx) => {
            tx.executeSql(
                networkSql.createV3NetworkQueueTable,
                null,
                function success() {
                    return resolve();
                },
