    ...
    render(){
        return (
            <Router>
                <Lightbox>
                    <Scene>
                        <Scene key={ROUTER_SCENE_KEYS.launch} component={Launch} hideNavBar />
                        <Scene key={ROUTER_SCENE_KEYS.lightbox} hideNavBar>
                            <Scene key={ROUTER_SCENE_KEYS.main}
                                ...
                                <Scene key={ROUTER_SCENE_KEYS.timeline} component={MainScreen} initial={this.state.loginState} title={I18n.t('FrontM')} />
                                <Scene key={ROUTER_SCENE_KEYS.loginScreen} component={LoginScreen} initial={!this.state.loginState} hideNavBar/>
                                <Scene key={ROUTER_SCENE_KEYS.signupScreen} component={SignupScreen} hideNavBar/>
