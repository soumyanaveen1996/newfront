...
export default class TelnetClient extends events.EventEmitter {
    ...
    connect(opts) {
        return new Promise((resolve, reject) => {
            const host =
                typeof opts.host !== 'undefined' ? opts.host : '127.0.0.1';
            const port = typeof opts.port !== 'undefined' ? opts.port : 23;
            this.timeout =
                typeof opts.timeout !== 'undefined' ? opts.timeout : 500;

            // Set prompt regex defaults
            this.shellPrompt =
                typeof opts.shellPrompt !== 'undefined'
                    ? opts.shellPrompt
                    : /(?:\/ )?#\s/;
            this.loginPrompt =
                typeof opts.loginPrompt !== 'undefined'
                    ? opts.loginPrompt
                    : /login[: ]*$/i;
            this.passwordPrompt =
                typeof opts.passwordPrompt !== 'undefined'
                    ? opts.passwordPrompt
                    : /Password[: ]*$/i;
            ...
            this.username =
                typeof opts.username !== 'undefined' ? opts.username : 'root';
            this.password =
                typeof opts.password !== 'undefined' ? opts.password : 'guest';
            this.irs = typeof opts.irs !== 'undefined' ? opts.irs : '\r\n';
            this.ors = typeof opts.ors !== 'undefined' ? opts.ors : '\n';
            this.echoLines =
                typeof opts.echoLines !== 'undefined' ? opts.echoLines : 1;
            this.stripShellPrompt =
                typeof opts.stripShellPrompt !== 'undefined'
                    ? opts.stripShellPrompt
                    : true;
            this.pageSeparator =
                typeof opts.pageSeparator !== 'undefined'
                    ? opts.pageSeparator
                    : '---- More';
            this.negotiationMandatory =
                typeof opts.negotiationMandatory !== 'undefined'
                    ? opts.negotiationMandatory
                    : true;
            this.initialLFCR =
                typeof opts.initialLFCR !== 'undefined'
                    ? opts.initialLFCR
                    : false;
            this.execTimeout =
                typeof opts.execTimeout !== 'undefined'
                    ? opts.execTimeout
                    : 2000;
            this.sendTimeout =
                typeof opts.sendTimeout !== 'undefined'
                    ? opts.sendTimeout
                    : 2000;
            this.maxBufferLength =
                typeof opts.maxBufferLength !== 'undefined'
                    ? opts.maxBufferLength
                    : 1048576;
    ...
    exec(cmd, opts, callback) {
        ...
        return new Promise((resolve, reject) => {
            if (opts && opts instanceof Object) {
                ...
                this.failedLoginMatch =
                    opts.failedLoginMatch || this.failedLoginMatch;
                ...
                this.echoLines =
                    typeof opts.echoLines !== 'undefined'
                        ? opts.echoLines
                        : this.echoLines;
                this.maxBufferLength =
                ...
                this.socket.write(data, () => {
                    ...
                    function sendHandler(sendData) {
                        ...
                        if (opts && opts.waitfor !== undefined) {
                            if (!response.includes(opts.waitfor)) {
                                return;
                            }
    ...
    _parseData(chunk, callback) {
        ...
        if (this.state === 'getprompt') {
            ...
            if (this.echoLines === 1) {
                ...
                this.response.splice(0, this.echoLines);
            }
