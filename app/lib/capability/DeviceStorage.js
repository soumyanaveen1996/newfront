...
export default class DeviceStorage {
	 ...
	 * @return {Promise}
	 */
    static save = (key, obj) => new Promise((resolve, reject) => {
	 ...
	 * @return {Promise}
	 */
    static update = (key, value) => new Promise((resolve, reject) => {
	 ...
	 * @return {Promise}
	 */
    static delete = (key) => new Promise((resolve, reject) => {
	 ...
	 * @return {Promise}
	 */
    static getArrayValues = (key) => new Promise((resolve, reject) => {
	 ...
	 * @return {Promise}
	 */
    static saveArrayValue = (key, val) => new Promise((resolve, reject) => {
	 ...
	 * @return {Promise}
	 */
    static saveArrayValues = (key, values) => new Promise((resolve, reject) => {
	 ...
	 */
    static removeArrayValue = (key, val) => new Promise((resolve, reject) => {
	 ...
	 * @return {Promise} resolving to the popped first element
	 */
    static removeAllArrayValues = (key) => new Promise((resolve, reject) => {
