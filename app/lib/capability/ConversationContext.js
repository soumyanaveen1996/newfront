...
export default class ConversationContext {
        ...
        new Promise((resolve, reject) => {
            ...
            ConversationContext._getBotConversationContext(botContext)
                .then(function(context) {
                    ...
                    const allParticipants = context.participants.concat(
                        participants
                    );
    ...
    static updateParticipants = function(conversationContext, participants) {
        ...
        conversationContext.participants =
            conversationContext.participants || [];
        conversationContext.participantsInfo = conversationContext.participantsInfo.concat(
            filteredParticipants
        );
        conversationContext.participants = conversationContext.participants.concat(
